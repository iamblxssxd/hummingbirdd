export const commonWords = [
  ...
  'under', 'underneath', 'unlike', 'until', 'up', 'upon', 'versus', 'via', 'with', 'within', 'without', 'i', 'he',
  'she', 'we', 'they', 'this', 'that', 'these', 'those', 'modals', 'can', 'could', 'able', 'may', 'might', 'shall',
  'should', 'must', 'will', 'would', 'have', 'be', 'been', 'is', 'are', 'was', 'were', 'a', 'an', 'the'
]